...
class ModelingJob(models.Model):
    ...
    model = models.ForeignKey(MLModel,on_delete=models.DO_NOTHING,blank=True,null=True)
    jobRef = models.ForeignKey(LabelingJob,on_delete=models.DO_NOTHING,blank=True,null=True)
    def __str__(self):
        return self.name