...
urlpatterns += [
    path('apis/labels', views.LabelSet.as_view({'get': 'list'}), name='api-label-detail'),
    path('apis/rules', views.RuleSet.as_view({'get': 'list'}), name='api-rule-detail'),
    path('apis/documents', views.DocumentSet.as_view({'get': 'list'}), name='api-document-detail'),
